...
# from dungeon_and_dragons.services.google_cloud_storage import upload_to_bucket
...
from routes import generate_adventure

logger = logging.getLogger(__name__)
logger.setLevel(logging.INFO)
app = FastAPI()
app.include_router(generate_adventure.adventure_router)


def main():
    "Initialize the FastAPI app and include the adventure_router."
    try:
